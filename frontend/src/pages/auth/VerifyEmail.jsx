...
export default function VerifyEmail() {
    ...
    // If a user navigates to this URL directly without an email param, catch it
    if (!email) {
        return (
            <div className="login-wrapper">
                <div className="login-card" style={{ textAlign: 'center' }}>
                    ...
                    <Link to="/signup" className="login-button" style={{ textDecoration: 'none', display: 'inline-block' }}>
                        Return to Sign Up
                    </Link>
                </div>
            </div>
        ...
        <div className="login-wrapper">
            <div className="login-card">
                ...
                <form onSubmit={handleVerify} className="login-form">
                    ...
                    {message && (
                        <div style={{ backgroundColor: '#f0fdf4', color: '#166534', padding: '12px 16px', borderRadius: '4px', fontSize: '14px', border: '1px solid #bbf7d0', marginBottom: '8px' }}>
                            {message}
                        </div>
                    )}
                    ...
                    <div className="input-group">
                        ...
                        <input
                            ...
                            style={{ textAlign: 'center', letterSpacing: '4px', fontSize: '18px', fontWeight: 'bold' }} // Styled specifically for a code
                        />
                    </div>
