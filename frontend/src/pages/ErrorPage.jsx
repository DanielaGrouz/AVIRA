  ...
  return (
    <div className="home-container not-found-wrapper">
      <div className="not-found-content">
        <div className="not-found-icon-wrapper">{currentError.icon}</div>
        ...
        <p className="not-found-text">{currentError.message}</p>
