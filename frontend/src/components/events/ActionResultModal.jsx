      ...
      <div className="modal-body">
        {isLoading ? (
          ...
          >
            ...
            ></div>
            <p
              style={{ marginTop: '20px', color: '#4a5568', fontSize: '1.1rem', fontWeight: '500' }}
            >
          ...
          <div
            ...
            style={
              image || type === 'tasks' || type === 'shopping' || type === 'stores'
                ...
                {data.map((store, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div>
                          <h3 style={{ margin: '0 0 6px 0', color: '#1a202c', fontSize: '1.1rem' }}>
                            🏪 {store.storeName}
                          </h3>
