...
const PhotoUpload = ({
    ...
    const handleUpload = async () => {
        ...
        // Simulate incremental progress until the real call resolves
        ...
        try {
            ...
            setProgress(100);
            // Brief pause so the bar visually hits 100% before hiding
    ...
    return (
        <div className="pu-wrapper">
            ...
            {/* Progress bar */}
            {isUploading && (
                <div className="pu-progress-track" role="progressbar" aria-valuenow={Math.round(progress)} aria-valuemin={0} aria-valuemax={100}>
            ...
            {selectedFile && (
                ...
                >
                    {isUploading
                        ? <FiLoader className="pu-spin-icon" />
                        : <FiUpload />
                    }
