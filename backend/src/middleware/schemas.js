...
const basePaginationSchema = z.object({
    ...
    sortDirection: z.coerce.number().int().refine(val => val === 1 || val === -1, {
...
module.exports = {
    idSchema, idAndGuestIdSchema, idAndTaskIdSchema, tokenParamSchema,
    locationQuerySchema, userSchema, optionalUserSchema, loginSchema,
    emailSchema, verifyEmailSchema, resetPasswordSchema, guestSchema,
    rsvpBodySchema, taskSchema, optionalTaskSchema, eventSchema,
    optionalEventSchema, eventPaginationSchema, taskPaginationSchema, guestPaginationSchema, userPaginationSchema
};