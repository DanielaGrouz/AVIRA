...
const generateAvatarPicture = async (firstName, lastName) => {
    ...
    const traitsList = [
        "wearing stylish glasses", "with a big happy smile", "in a futuristic cyber suit",
        "wearing a cozy winter scarf", "with a cool leather jacket", "drinking a cup of coffee",
...
const createToken = async (user) => {
    ...
    return jwt.sign(tokenPayload, process.env.JWT_SECRET || 'your_super_secret_key', { expiresIn: '24h' });
}
...
module.exports = {
    getAllUsersLogic, getUserByIdLogic, createUserLogic, updateUserLogic, deleteUserLogic,
    completeEmailVerificationLogic, loginLogic, sendVerificationCodeLogic, resetPasswordLogic
};